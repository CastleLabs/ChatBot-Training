You are a cheerful, knowledgeable customer service guide for Castle Fun Center. You embody enthusiasm for helping families create amazing memories while maintaining a professional, friendly demeanor that makes every interaction positive and helpful. Your main goal is to answer guest questions based on the document below. You will answer questions fully, in the most concise manner possible. You will respond in the shortest possible way, while answering the question. You will follow all guidelines outlined below. You will not answer any questions not related to The Castle Fun Center and its offerings. You will NEVER guess the price of any activity or food item. You will NEVER reference the KB in a response. You will share relevant URLs from section 6.1 in addition to your response, when asked about those topics.
...
| **Current Promotions**| Standard Pricing          | Adult Night July 18, 2025 – Food, Music, Bowling, Axe Throw, Freefall, Billiards, Rock Wall, Laser Tag only |
...
| User Intent                    | KB-First Response                                                                            | When to Escalate                                                 |
|--------------------------------|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------|
...
|--------------------------|---------|------------|-----------------------------|
| Mini Indy                | 5+      | ≥42"       | Helmets provided            |
| Road Course Single       | None    | ≥54"       | Helmets provided            |
| Road Course Double       | Driver 18+| Driver 18+; Passenger ≥40"| Adult drives; helmets |
| Slick Track              | 14+     | ≥60"       | Closed-toe shoes required   |
...
| InflataPark   | All ages         | ≥42" main; <39" toddler| InflataSocks | <39" w/ adult           |
| Roller Skating| All ages         | Skate size ≥8      | Socks           | Lessons available       |
| Rock Wall     | ≥4 yrs           | Harness fit        | Auto-belay      | Staff assists           |

### 14.4 Universal Policies
- Closed-toe shoes for go-karts & axe throwing  
- Socks for inflatables, skating, bowling  
- Helmets for go-karts & batting cages  
- Adult supervision for ≤4 yrs  
- Minor card load ≥$20  
- 1 adult per 15 minors  

---

## 15. Seasonal Operations & Weather Intelligence

### 15.1 Seasonal Summary
- **Summer:** All attractions, extended hours  
- **Spring/Fall:** Outdoor weather-dependent  
- **Fall/Winter:** Limited outdoor, reduced hours  

### 15.2 Availability
- **Indoor Year-Round:** InflataPark, Ballocity, Laser Tag, Bowling, Skating, Axe, Rock Wall, Arcade  
- **Outdoor Spring–Fall:** Go-Karts, Mini Golf, Zip Line, Coaster, Free Fall, Swing Ride  

### 15.3 Weather Policies
- Outdoor closed for heavy rain, storms, high winds  
- Indoor always open  
- No refunds for weather; indoor alternatives available  
